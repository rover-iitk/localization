...
if("FALSE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-robot-localization-2.4.5)
  set(robot_localization_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-robot-localization-2.4.5/obj-x86_64-linux-gnu/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
